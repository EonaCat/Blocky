...
namespace EonaCat.Dns
{
    public static class LoggerMultiCast
    {
        ...
        public static void Log(string message, ELogType logType = ELogType.INFO, bool writeToConsole = false)
        {
            if (IsDisabled)
                return;
        ...
        public static void Log(Exception exception, string message = "", bool writeToConsole = false)
        {
            if (IsDisabled)
                return;
