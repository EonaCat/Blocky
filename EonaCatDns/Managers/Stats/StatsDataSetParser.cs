...
namespace EonaCat.Dns.Managers.Stats
{
    ...
    {
        internal static async Task CreateQueryTypesArrayAsync(JsonTextWriter jsonWriter, IDictionary<string, List<StatsLog>> data)
        {
        ...
        internal static async Task CreateLastQueriesArrayAsync(JsonTextWriter jsonWriter, IDictionary<string, List<StatsLog>> data)
        {
            ...
            if (lastQueries != null)
            {
                ...
                {
                    var domain = await DatabaseManager.Domains.FirstOrDefaultAsync(x => x.Url == item.Name).ConfigureAwait(false);
                    await jsonWriter.WriteStartObjectAsync().ConfigureAwait(false);
                    if (domain != null)
                    {
        ...
        internal static async Task CreateTopBlockedDomainsAsync(JsonTextWriter jsonWriter, IDictionary<string, List<StatsLog>> data)
        {
        ...
        internal static async Task CreateTopDomainsAsync(JsonTextWriter jsonWriter, IDictionary<string, List<StatsLog>> data)
        {
        ...
        internal static async Task CreateTopClientsArrayAsync(JsonTextWriter jsonWriter, IDictionary<string, List<StatsLog>> data)
        {
            ...
            if (topClients != null)
            {
                ...
                {
                    var client = await DatabaseManager.Clients.FirstOrDefaultAsync(x => x.Ip == item.Name).ConfigureAwait(false);
                    await jsonWriter.WriteStartObjectAsync().ConfigureAwait(false);
                    await jsonWriter.WritePropertyNameAsync("name").ConfigureAwait(false);
                    await jsonWriter.WriteValueAsync(item.Name).ConfigureAwait(false);
        ...
        internal static async Task CreateStatisticsDataArrayAsync(JsonTextWriter jsonWriter, IDictionary<string, List<StatsLog>> data)
        {
            await jsonWriter.WritePropertyNameAsync("statisticsData").ConfigureAwait(false);
            await jsonWriter.WriteStartObjectAsync().ConfigureAwait(false);
            var stats = data != null && data.ContainsKey(ConstantsDns.Stats.TotalQueries) ? data[ConstantsDns.Stats.TotalQueries] : null;
            ...
            if (data != null)
            {
                ...
                {
                    WriteChartDataSet(jsonWriter, "Total Queries", StatsManagerApi.TotalQueriesBackgroundColor + StatsManagerApi.Transparency,
                ...
                {
                    WriteChartDataSet(jsonWriter, "No Error", StatsManagerApi.NoErrorBackgroundColor + StatsManagerApi.Transparency, StatsManagerApi.NoErrorBorderColor,
                        data[ConstantsDns.Stats.TotalNoError]);
                }

                if (data.ContainsKey(ConstantsDns.Stats.TotalCached))
                {
                    WriteChartDataSet(jsonWriter, "Cached", StatsManagerApi.CachedBackgroundColor + StatsManagerApi.Transparency, StatsManagerApi.CachedBorderColor,
                        data[ConstantsDns.Stats.TotalCached]);
                }

                if (data.ContainsKey(ConstantsDns.Stats.TotalServerFailure))
                {
                    WriteChartDataSet(jsonWriter, "Server Failure", StatsManagerApi.ServerFailureBackgroundColor + StatsManagerApi.Transparency,
                ...
                {
                    WriteChartDataSet(jsonWriter, "Name Error", StatsManagerApi.NameErrorBackgroundColor + StatsManagerApi.Transparency,
                ...
                {
                    WriteChartDataSet(jsonWriter, "Refused", StatsManagerApi.RefusedBackgroundColor + StatsManagerApi.Transparency, StatsManagerApi.RefusedBorderColor,
                        data[ConstantsDns.Stats.TotalRefused]);
                }

                if (data.ContainsKey(ConstantsDns.Stats.TotalBlocked))
                {
                    WriteChartDataSet(jsonWriter, "Blocked", StatsManagerApi.BlockedBackgroundColor + StatsManagerApi.Transparency, StatsManagerApi.BlockedBorderColor,
                        data[ConstantsDns.Stats.TotalBlocked]);
                }

                if (data.ContainsKey(ConstantsDns.Stats.TotalClients))
                {
                    WriteChartDataSet(jsonWriter, "Clients", StatsManagerApi.ClientsBackgroundColor + StatsManagerApi.Transparency, StatsManagerApi.ClientsBorderColor,
        ...
        internal static async Task CreateStatsArrayAsync(JsonTextWriter jsonWriter, IDictionary<string, List<StatsLog>> data)
        {
